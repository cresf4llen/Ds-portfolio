  ...
  return (
    <main className="bg-background min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-6 py-24">
        ...
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">Interior Designer Portfolio</h1>
          <p className="text-xl text-muted-foreground">Eka Papamichail</p>
        </div>
        ...
        <div className="prose prose-invert max-w-none">
          <p className="text-lg text-muted-foreground leading-relaxed">
            An elegant portfolio website designed for a Georgian interior designer, 
            showcasing beautiful residential projects. The website features an immersive 
            gallery experience with smooth scroll animations and modern interactions, 
